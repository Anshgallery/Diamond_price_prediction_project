...
# PyTest is a Python testing framework used to automatically
# test our application.

# It checks whether our functions, modules, APIs, and ML pipeline
# are working as expected.

# PyTest automatically finds:
# 1. Files whose names start with "test_"
#    Example:
#       test_model.py
#       test_data_transformation.py
#
# 2. Functions whose names start with "test_"
#    Example:
...
# "assert" is a validation checkpoint.
...
#
# Meaning:
# "Check whether the transformed data contains rows."
...
#
# Meaning:
# "Check whether preprocessing file was saved."

# ------------------------------------------------------------
# WHY DO WE USE PYTEST?
# ------------------------------------------------------------

# Instead of manually checking the application every time,
# PyTest checks everything automatically.

# Every time a developer pushes code to GitHub,
# GitHub Actions (or Jenkins) can automatically run:
#
# pytest
#
# If all tests pass
#      ↓
# Continue CI/CD Pipeline
#
# If any test fails
#      ↓
# Stop the pipeline

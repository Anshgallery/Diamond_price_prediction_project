from DiamondPricePrediction.component.data_ingestion import (
    DataIngestion,
    Data_ingestion_config,
)
from DiamondPricePrediction.component.data_transformation import (
    DataTransformation,
...
from DiamondPricePrediction.component.model_evaluation import ModelEvaluation
...
class traning_flow:
    ...
    def start_data_transformation(self):
        ...
        x_train_arr, x_test_arr, y_train, y_test = obj.initiate_data_transformation(
    ...
    def start_model_traning(self):
        ...
        obj = ModelTrainer()
        best_fit_model_name, max_r2_accuracy = obj.initiate_model_trainer(
    ...
    def start_model_evaluation(self):
        x_train_arr, x_test_arr, y_train, y_test = self.start_data_transformation()
        obj = ModelEvaluation()
        obj.initiate_model_evaluation(x_train_arr, x_test_arr, y_train, y_test)

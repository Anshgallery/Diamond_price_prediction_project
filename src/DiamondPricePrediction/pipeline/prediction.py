...
class PredictionPipeline:
    ...
    def prediction(self,features): # feature are dataframe 
        try :
            ...
            scale_data =preprocessor.transform(features) # encoding thing done here to make data perfect 

            pred =model.predict(scale_data) # jiss model ne sabse achi prediction di ha ab usko lo and fitt krdo like obj.predit(x_train)
            return pred
...
class Customdata:
    def __init__(self,
                 ...
                 cut:str,
                 color:str,
                 clarity:str): # independent  variable 
